...
var EventCell = function (_React$Component) {
  ...
  EventCell.prototype.render = function render() {
    ...
    var title = (0, _accessors.accessor)(event, titleAccessor),
        ...
        backgroundColor = event.color && (0, _ishex.isHexColor)(event.color) ? event.color : '#3174ad',
        color = '#fff';
    ...
    if ((0, _contrast2.default)(backgroundColor) === 'light') {
      color = '#000';
    }
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        {
          style: _extends({}, props.style, style, { backgroundColor: backgroundColor, color: color }),
