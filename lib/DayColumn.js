...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderEvents = function () {
    ...
    return styledEvents.map(function (_ref, idx) {
      ...
      var backgroundColor = event.color && (0, _ishex.isHexColor)(event.color) ? event.color : '#3174ad';
      var color = '#fff';
        ...
        _react2.default.createElement(
          'div',
          {
            style: _extends({}, xStyle, (_extends2 = {
              top: top + '%',
              height: height + '%'
            }, _extends2[isRtl ? 'right' : 'left'] = Math.max(0, xOffset) + '%', _extends2.width = width + '%', _extends2.backgroundColor = backgroundColor, _extends2.color = color, _extends2)),
            title: label + ': ' + title,
